...
config.AssignAction('null','apple',{'_id':'insert','attr':{}})
config.AssignAction('null','apple',{'_id':'delete','attr':{}})
...
config.AssignAction('null','apple',{'_id':'insert','attr':{}})
config.Consider('null','apple','insert','insertActivity')
config.Consider('null','apple','delete','deleteActivity')
config.Consider('null','apple','insert','manage')
config.Consider('null','apple','delete','manage')

#create John, create role admin, assign John to admin
config.AssignSubject('null','apple',{'_id':'John','attr':{}})
config.AssignRole('null','apple',{'_id':'admin','attr':{}})
config.Empower('null','apple','John','admin')
